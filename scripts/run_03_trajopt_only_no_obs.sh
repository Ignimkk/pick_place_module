#!/usr/bin/env bash
# =================================================================
# 03. mode=trajopt_only  obstacle=no_obs
#
# 사전 조건 (사용자가 직접 실행):
...
OUTPUT_CSV="${RESULTS_DIR}/03_trajopt_only_no_obs.csv"
